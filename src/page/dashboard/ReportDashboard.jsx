...
const ReportDashboard = () => {
    ...
    const trafficData = {
        ...
        datasets: [
            {
                label: 'Responded Reports',
                data: [20, 30, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140],
                fill: false,
                backgroundColor: 'rgba(53, 162, 235, 0.2)', // Màu xanh cho báo cáo đã phản hồi
                borderColor: 'rgb(53, 162, 235)',
                borderWidth: 2,
                tension: 0.4,
            },
            {
                label: 'Unresponded Reports',
                data: [10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65],
                fill: false,
                backgroundColor: 'rgba(255, 99, 132, 0.2)', // Màu đỏ cho báo cáo chưa phản hồi
    ...
    return (
        <CContainer>
            ...
            <CRow className="mt-4">
                <CCol sm="12" md="12">
                    <CCard>
                        <CCardHeader className="text-center">Thống kê cáo buộc</CCardHeader>
                        <CCardBody>
